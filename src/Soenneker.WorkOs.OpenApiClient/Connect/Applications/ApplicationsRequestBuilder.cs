...
namespace Soenneker.WorkOs.OpenApiClient.Connect.Applications
{
    ...
    public partial class ApplicationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ApplicationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.WorkOs.OpenApiClient.Connect.Applications.ApplicationsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ApplicationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerList422Response">When receiving a 422 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.WorkOs.OpenApiClient.Models.ConnectApplicationList> GetAsync(Action<RequestConfiguration<global::Soenneker.WorkOs.OpenApiClient.Connect.Applications.ApplicationsRequestBuilder.ApplicationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "422", global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerList422Response.CreateFromDiscriminatorValue },
            };
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreate404Response">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreate422Response">When receiving a 422 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.WorkOs.OpenApiClient.Models.ConnectApplication?> PostAsync(global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.WorkOs.OpenApiClient.Models.ConnectApplication> PostAsync(global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                { "404", global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreate404Response.CreateFromDiscriminatorValue },
                { "422", global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreate422Response.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.WorkOs.OpenApiClient.Models.ApplicationsControllerCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
