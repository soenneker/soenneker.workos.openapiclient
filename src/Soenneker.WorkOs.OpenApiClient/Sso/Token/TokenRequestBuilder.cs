...
{
    /// <summary>
    /// Builds and executes requests for operations under \sso\token
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class TokenRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.WorkOs.OpenApiClient.Sso.Token.TokenRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::Soenneker.WorkOs.OpenApiClient.Models.SsoControllerToken400Response">When receiving a 400 status code</exception>
        /// <exception cref="global::Soenneker.WorkOs.OpenApiClient.Models.SsoControllerToken404Response">When receiving a 404 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.WorkOs.OpenApiClient.Models.SsoTokenResponse> PostAsync(global::Soenneker.WorkOs.OpenApiClient.Models.TokenQueryDto body, Action<RequestConfiguration<global::Soenneker.WorkOs.OpenApiClient.Sso.Token.TokenRequestBuilder.TokenRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.WorkOs.OpenApiClient.Models.SsoControllerToken400Response.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.WorkOs.OpenApiClient.Models.SsoControllerToken404Response.CreateFromDiscriminatorValue },
                { "422", global::Soenneker.WorkOs.OpenApiClient.Models.SsoControllerToken422Response.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.WorkOs.OpenApiClient.Models.SsoTokenResponse>(requestInfo, global::Soenneker.WorkOs.OpenApiClient.Models.SsoTokenResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get an access token along with the user [Profile](/reference/sso/profile) using the code passed to your [Redirect URI](/reference/sso/get-authorization-url/redirect-uri).
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.WorkOs.OpenApiClient.Sso.Token.TokenRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.WorkOs.OpenApiClient.Sso.Token.TokenRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.WorkOs.OpenApiClient.Sso.Token.TokenRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get an access token along with the user [Profile](/reference/sso/profile) using the code passed to your [Redirect URI](/reference/sso/get-authorization-url/redirect-uri).
        /// </summary>
